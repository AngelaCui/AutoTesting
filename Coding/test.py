...
def main():
    ...
    while True:
        try:
            #ATimer(0.12, ser, Data_get, Tmp)
            t = threading.Timer(0.1, MainProcess, [ser, Data_get, Tmp])
            t.start()
        except: 
            print('Timing error')
            break
